import{P as d,O as x,V as l,B as m,a as u,M as v,S as p,T as h,G as y,W as g,b as f,C as w,c as z,d as b}from"./vendor.2e3bd11a.js";const C=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerpolicy&&(i.referrerPolicy=t.referrerpolicy),t.crossorigin==="use-credentials"?i.credentials="include":t.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(t){if(t.ep)return;t.ep=!0;const i=n(t);fetch(t.href,i)}};C();class V extends d{constructor(e={}){super(e==null?void 0:e.fov,e==null?void 0:e.aspect,e==null?void 0:e.near,e==null?void 0:e.far);var n;this.time=0,this.enableControl=!0,!!(e==null?void 0:e.canvas)&&(!this.enableControl||(this.controls=new x(this,e==null?void 0:e.canvas),this.controls.enableDamping=(e==null?void 0:e.enableDamping)||!1,this.controls.dampingFactor=(n=e==null?void 0:e.dampingFactor)!=null?n:.2))}init(){this.position.set(-10,5,5),this.lookAt(new l(0,0,0))}resize(e){this.aspect=e.x/e.y,this.updateProjectionMatrix()}update(e){const n=14;this.time+=e,this.position.set(Math.sin(this.time*.5)*n,0,Math.cos(this.time*.5)*n),!!this.controls&&this.controls.update()}}class M extends m{constructor(e,n){super();this.num=e,this.length=n,this.createGeometry()}createGeometry(){const e=new Float32Array(this.num*this.length*3),n=new Uint32Array((this.num*this.length-1)*3),s=new Float32Array(this.num*this.length*2);for(let t=0;t<this.num;t++)for(let i=0;i<this.length;i++){const o=t*this.length+i,a=o*2,r=o*3;e[r]=0,e[r+1]=0,e[r+2]=0,s[a]=i/this.length,s[a+1]=t/this.num,n[r]=o,n[r+1]=Math.min(o+1,t*this.length+this.length-1),n[r+2]=Math.min(o+1,t*this.length+this.length-1)}this.setAttribute("position",new u(e,3)),this.setAttribute("uv",new u(s,2)),this.setIndex(new u(n,1))}}var P=`#include <common>
